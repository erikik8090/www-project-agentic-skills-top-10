...
| **AST04 — Insecure Metadata** | High | P1: Cybersecurity, P4: Transparency, P3: Ethics & Bias, P7: Audit | Phase 2 (schema valid., secure code), Phase 3 (behavior check, deser. testing) | Schema validation on fields; ASCII smuggling scans; Brand impersonation checks; Risk tier cross-reference; Safe YAML/JSON loaders; Sandboxed parsing; Allowlisted config keys; Isolated dependency install |
